...
export function Table({
  ...
  return (
    <div className="w-full overflow-x-auto rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-[var(--color-card)]">
      <table
...
export function Th({
  ...
  return (
    <th
      className={cn(
        "px-4 py-2.5 text-xs font-medium text-[var(--color-muted-foreground)] uppercase tracking-wide",
        className,
      )}
      {...rest}
    />
