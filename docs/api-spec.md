...
대표 운영자와 그룹 운영자가 사용하는 화면이다. 대표 운영자는 워크스페이스 전체를, 그룹 운영자는 자신의 접근 그룹 범위를 기준으로 사용한다.
...
- 대표 운영자와 그룹 운영자는 초대 링크를 생성할 수 있다.
- 그룹 운영자는 `owner_admin`을 초대할 수 없고, 자기 접근 그룹·수업 범위만 초대 대상에 연결할 수 있다.
